...
new Chart(document.getElementById("barchart1"), {
  ...
  options: {
    ...
    title: {
      display: true,
      text: "سود را در میلیون ها نفر پیش بینی کرد",
    },
    scales: {
      yAxes: [
        {
...
var myChart = new Chart(ctx, {
  ...
  data: {
    ...
    labels: ["سیاه", "سبز", "رنگ زرد", "قرمز", "آبی"],
  },
  options: {
    responsive: true,
    legend: {
...
if (ctx) {
  ...
  var myChart = new Chart(ctx, {
    type: "line",
    data: {
      labels: ["ژانویه", "فوریه", "مارس", "ماه آوریل", "ممکن است", "ژوئن", "جولای"],
      datasets: [
        {
