...
function revenueChart() {
  ...
  var options = {
    ...
    xaxis: {
      categories: ["دوشنبه", "سه‌شنبه", "چهارشنبه", "پنج‌شنبه", "جمعه","یک‌شنبه" , "شنبه" ],
...
function smallChart() {
  ...
  var sales_chart = document.getElementById("smallChart2").getContext("2d");
  ...
  var sales_chart = document.getElementById("smallChart3").getContext("2d");
